...
class TestJudgeProfile(unittest.TestCase):
    ...
    def test_003_assign_profile_to_point_user(self):
        ...
        r = requests.post(
            ...
            data=json.dumps(data), headers=headers, verify=False)
        print gl.url + ":7111/acl_admin/profile/AQACd5VVkc7RCAAA1sIDurnF6BSXKwAA/user"
        print r, r.text



    def test_004_add_profile_funcLAs(self):
        """"""
        headers = {
        ...
        data = {
            ...
            "funcLAs": [
                {
                    "function_name": "AssignRole",
                    "callable": True
                },
                {
                    "function_name": "ConvertLeadsToAccountAndContact",
                    "callable": True
                },
                {
                    "function_name": "CreateTerritoryType",
                    "callable": True
                },
                {
                    "function_name": "DefineLeadsTerritory",
                    "callable": True
                }
            ]
        }
        r = requests.put(
            gl.url + ":7111/acl_admin/profile/AQACk5HxFIZ1DAAAdyuRdDW79BSwAwAA/function_level_access",
            data=json.dumps(data), headers=headers, verify=False)
        print gl.url + ":7111/acl_admin/profile/AQACk5HxFIZ1DAAAdyuRdDW79BSwAwAA/function_level_access"
        print r, r.text
