...
class TestJudgeOwd(unittest.TestCase):
    ...
    def test_001_acl_add_owd_item(self):
        ...
        r = requests.post("http://10.100.250.6:7111/acl_admin/organization_wide_default/owd_item", data=json.dumps(data),
                          headers=headers)
        print r, r.text
    ...
    def test_002_get_acl_owd(self):
        ...
        r = requests.get("http://10.100.250.6:7111/acl_admin/organization_wide_default",
                          headers=headers)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        result = json.loads(r.text)
