...
class TestJudgeGroup(unittest.TestCase):
    ...
    def test_001_create_acl_group(self):
        ...
        r = requests.post(gl.url + ":7111/acl_admin/group", data=json.dumps(data),
                          headers=headers)
        print r, r.text
    ...
    def test_002_update_group_by_group_id(self):
        ...
        print "请求参数：" + json.dumps(data)
        r = requests.put(gl.url + ":7111/acl_admin/group/" + gl.acl_group_id, data=json.dumps(data),
                         headers=headers)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        result = json.loads(r.text)
    ...
    def test_003_get_group_by_id(self):
        ...
        # print "请求参数：" + json.dumps(data)
        r = requests.get(gl.url + ":7111/acl_admin/group/" + gl.acl_group_id,
                         headers=headers)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        result = json.loads(r.text)
    ...
    def test_004_get_all_groups(self):
        ...
        # print "请求参数：" + json.dumps(data)
        r = requests.get(gl.url + ":7111/acl_admin/group",
                         headers=headers)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        result = json.loads(r.text)
    ...
    def test_005_add_group_member(self):
        ...
        print "请求参数：" + json.dumps(data)
        r = requests.post(gl.url + ":7111/acl_admin/group/" + gl.acl_group_id + "/member", data=json.dumps(data),
                          headers=headers)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        result = json.loads(r.text)
    ...
    def test_006_get_acl_group_member(self):
        ...
        r = requests.get(gl.url + ":7111/acl_admin/group/" + gl.acl_group_id + "/member",
                         headers=headers)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        result = json.loads(r.text)
    ...
    def test_007_delete_group_member(self):
        ...
        r = requests.delete(
            gl.url + ":7111/acl_admin/group/" + gl.acl_group_id + "/member/" + str(gl.acl_group_member_type) + "/" + gl.acl_group_member_id,
            headers=headers)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        result = json.loads(r.text)
    ...
    def test_008_delete_group_by_id(self):
        ...
        r = requests.delete(
            gl.url + ":7111/acl_admin/group/" + gl.acl_group_id,
            headers=headers)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        result = json.loads(r.text)
