...
class TestData_Online(unittest.TestCase):
    """测试 date 相关的接口"""
    ...
    def test_1_get_default_values(self):
        ...
        r = requests.get(
            gl.url_online + "/dml/api/"+gl.api_version+"/" + gl.online_tenant_name + "/" + gl.online_meta_name + "/default-values",
    ...
    def test_2_create_data_in_meta(self):
        ...
        data = {"objects": [{"name": "商机autotest1012160510", "AccountID": "AQACd5VVkc5CaQAAmxK7VjLO8xSekgIA",
                             ...
                             "Description": None},{"name": "商机autotest1012160510", "AccountID": "AQACd5VVkc5CaQAAmxK7VjLO8xSekgIA",
                             "Amount": {"symbol": "CNY", "value": 10000000}, "CloseDate": "2017-10-12T08:03:43Z",
                             "Stage1": "初步意向", "Probability1": "20%", "Stage2": "14天（30天）保持跟进", "Probability2": "20%",
                             "Phone": None, "IndustryCategory": None, "Industry": None, "OtherService": None,
                             "AffiliatedDepartment": None, "Competitor": None,
        ...
        r = requests.post(gl.url_online + "/dml/api/"+gl.api_version+"/" + gl.online_tenant_name + "/" + gl.online_meta_name,
    ...
    def test_3_get_data_for_point_requirements(self):
        ...
        r = requests.get(
            gl.url_online + "/dml/api/"+gl.api_version+"/" + gl.online_tenant_name + "/" + gl.online_meta_name + "/query?order_by=updated_at&order_flag=DESC&update_date=" + update_date +
            "&offset=0&limit=50&curField=updated_at&curFlag=DESC&"
    ...
    def test_4_get_data_from_data_id(self):
        ...
        r = requests.get(
            gl.url_online + "/dml/api/"+gl.api_version+"/" + gl.online_tenant_name + "/" + gl.online_meta_name + "/" + gl.data_id[
                randnum],
            headers=headers, verify=False)
        print r, r.text
        self.assertEqual(r.status_code, 200)
    ...
    def test_6_transfer_data_by_id(self):
        ...
        data = {
            "owner": "AQACd5VVkc7RCAAAXzvXDZDD7BRMPwAA"
        }
    ...
    def test_7_transfer_data_batch(self):
        ...
        r = requests.put(
            gl.url_online + "/dml/api/"+gl.api_version+"/" + gl.online_tenant_name + "/" + gl.online_meta_name + "/object_list/transfer",
            data=json.dumps(data), headers=headers, verify=False)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        self.assertEqual(r.json()["code"], 0)
    ...
    def test_8_delete_data_by_id(self):
        ...
        r = requests.delete(
            gl.url_online + "/dml/api/"+gl.api_version+"/" + gl.online_tenant_name + "/" + gl.online_meta_name + "/" + id + "?version=" + str(
                gl.data_version[0]),
            headers=headers, verify=False)
        print r, r.text
        self.assertEqual(r.status_code, 200)
    ...
    def test_9_delete_data_batch(self):
        ...
        r = requests.delete(
            gl.url_online + "/dml/api/"+gl.api_version+"/" + gl.online_tenant_name + "/" + gl.online_meta_name + "/object_list",
            data=json.dumps(data), headers=headers, verify=False)
        print r, r.text
        self.assertEqual(r.status_code, 200)
        self.assertEqual(r.json()["code"], 0)
...
gl.suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestData_Online))
